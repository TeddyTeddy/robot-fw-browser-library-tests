...
add_button= f'//div[@id="content-main"]//a[contains(., {add_button_text})]'    		# in the upper center 3 of them
change_button= f'//div[@id="content-main"]//a[contains(., {change_button_text})]'    # in the upper center 3 of them
